#pragma once
#include <GL/glew.h>
#include "Dependencies/glm-0.9.9.8/glm/glm/glm.hpp"
#include "./Dependencies/glm-0.9.9.8/glm/glm/gtc/matrix_transform.hpp"
#include "./Dependencies/glm-0.9.9.8/glm/glm/gtc/type_ptr.hpp"
#include <ft2build.h>
